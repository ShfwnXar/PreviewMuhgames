    ...
    <div className="max-w-6xl space-y-6">
      ...
      <div className="bg-white border rounded-xl p-6 shadow-sm">
        <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-3">
          <div>
            <h1 className="text-2xl font-bold">Admin • Panel Download</h1>
            <p className="text-gray-600 mt-2">
              Upload <b>panduan / formulir / template / pengumuman</b> agar tampil di halaman <b>/download</b>.
            </p>
            <div className="text-xs text-gray-500 mt-2">
              Penyimpanan sementara FE-only: metadata di localStorage, file di IndexedDB (browser).
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div className="md:col-span-3">
            ...
            <div className="text-xs text-gray-500 mt-1">
              Saran: PDF. Maks 10MB (sementara FE-only).
            </div>
          </div>
        </div>
